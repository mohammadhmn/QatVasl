# QatVasl Documentation Index

This folder contains both operations docs and beginner developer docs.

If you are completely new to Swift/SwiftUI/macOS development, follow this order:
...
- I just want to use the app:
  ...
  - `docs/03-daily-ops-checklist.md`
- I want to understand Swift + SwiftUI basics first:
  - `docs/05-swift-swiftui-macos-primer.md`
- I want to modify app behavior:
  - `docs/06-codebase-walkthrough.md`
- I want to build release artifacts (`.app`, `.dmg`):
